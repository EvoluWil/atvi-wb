...
public class Listar10Maior extends Listagem {
	private List<Cliente> clientes;
	public Listar10Maior(List<Cliente> clientes) {
	...
	public void listar() {
		...
		Map<Cliente, Integer> listOrder = new TreeMap<Cliente, Integer>(Collections.reverseOrder());
